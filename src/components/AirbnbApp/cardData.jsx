  export default [
  {
    ...
    price: 136,
    coverImg: "../../../images/swiming-lady.png",
    stats: {
      rating: 5.0,
      reviewCount: 6,
    },
  ...
  {
    id: 5,
    title: "The journey of Bull Dog",
    description:
      "Experience the beautiful Norwegian landscape and meet new friends all while conquering rugged terrain on your mountain bike. (Bike provided!)",
    price: 200,
    coverImg: "../../../images/dog2.jpg",
    stats: {
      rating: 4.8,
      reviewCount: 2,
    },
  ...
  {
    id: 7,
    title: "Missing Queen's Corgi",
    description:
      "Experience the beautiful Norwegian landscape and meet new friends all while conquering rugged terrain on your mountain bike. (Bike provided!)",
    price: 3000,
    coverImg: "../../../images/dog4.jpg",
    stats: {
      rating: 4.8,
      reviewCount: 2,
    },
